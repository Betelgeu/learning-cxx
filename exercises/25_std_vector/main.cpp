...
// 1. sizeof(vec)的大小固定，至于数据类型有关
// 2. 注意区分size和capacity
// 3. resize只会改变其中的size， 只会增加元素超过capacity时，才会给vec扩容, 增加capacity
...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Fill in the correct value.");
        {
            ...
            vec.resize(16);
            // resize只会改变其中的capacity， 只会增加元素超过capacity时，才会给vec扩容
